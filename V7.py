...
# Security & Person Detection Globals
security_mode = False
alarm_active = False
...
def gen_frames():
    ...
    global current_person_count, alarm_active, security_mode
    ...
    while True:
        ...
        # Security Armed Mode Logic: Trigger alarm if armed and person detected
        ...
        # On-screen camera HUD (People Count & Security Status)
...
<body>
        ...
        <div style="display: flex; flex-direction: column; gap: 25px;">
            <div class="stat-grid">
                ...
                <div class="stat-box">
                    ...
                    <span class="stat-val" style="color:#00e5ff; font-size:15px;" id="sec-status">DISARMED</span>
                </div>
            </div>
    ...
    <script>
        ...
        // Web Audio Synthesizer for Local Browser Siren
        let audioCtx = null;
        let sirenOsc = null;
        ...
        function updateSecurityUI(isArmed) {
            ...
            let txt = document.getElementById('sec-status');
            if (isArmed) {
